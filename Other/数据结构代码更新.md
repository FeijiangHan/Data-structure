...
template<class E>
int BiLinkedList<E>::IndexOf(E ele)
{
	Node<E>* node = head->next;
	for (int i = 0; i < m_size; i++) {
		if (node->element == ele) {
...
template<class E>
bool BiLinkedList<E>::Contains(E ele)
{
	return IndexOf(ele) != NOT_CONTAINS;
}
...
template<class E>
E BiLinkedList<E>::Update(int index,E ele)
{
...
template<class E>
Node<E>* BiLinkedList<E>::node(int index)
{
...
template<class E>
void BiLinkedList<E>::add(int Ele)
{
	add(m_size, Ele);
}
...
template<class E>
void BiLinkedList<E>::add(int index, int Ele)
{
	/* 获得前驱后继 */
...
template<class E>
int BiLinkedList<E>::remove(int index)
{
